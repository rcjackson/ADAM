Batch processing
================
ADAM supports batch inference so that you can infer the location of the lake breeze over
...
-------------------------------------------
The :py:class:`~adam.io.RadarImage` class contains all of the information you need to perform
